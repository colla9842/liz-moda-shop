      ...
      <Card className="max-w-md mx-auto">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            {file && (<div className="text-sm text-gray-500">
          ...
          {uploadStatus && (<Alert variant={uploadStatus.type === 'success' ? 'default' : 'destructive'}>
              {uploadStatus.type === 'success' ? (<CheckCircle2 className="h-4 w-4"/>) : (<AlertCircle className="h-4 w-4"/>)}
