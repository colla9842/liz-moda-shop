      ...
      <div className="mb-6 relative z-10">
        <Select value={selectedMonth} onValueChange={handleMonthChange}>
          ...
          <SelectContent className="bg-gray-800/90 border-gray-700">
            {getMonthOptions().map((option) => (<SelectItem key={option.value} value={option.value} className="text-white hover:bg-gray-700/50">
                {option.label}
              </SelectItem>))}
          </SelectContent>
        </Select>
        ...
        <Card className="bg-gray-800/70 backdrop-blur-md shadow-md">
          ...
          <CardContent>
            {isLoading ? (<>
              ...
              </>) : (Object.keys(categoryExpenses).map(category => (<p key={category} className="text-lg text-white">
